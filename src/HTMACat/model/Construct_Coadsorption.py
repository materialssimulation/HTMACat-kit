...
def Construct_coadsorption(Path_Info,Model,spec_ads_stable):
    """
    Construct co-adsorption systems based on input adsorbates, surface
    dopants and slab configurations.

    Parameters
    ----------
    Path_Info : str
        The path to the file containing slab and lattice information.
    Model : str
        The path to the file containing dopant and adsorbate information.
    spec_ads_stable : dict
        A dictionary containing information about stable adsorbates

    Returns
    -------
    None
        This function does not return any values. It writes VASP input files
        for the co-adsorption systems generated by the function.
    """
    model = open(Model,'r+')

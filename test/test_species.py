...
from HTMACat.model.Species import Sim_Species, File_Species, Sml_Species, species_from_input, init_from_ads
...
def test_get_molecule(sim_species,file_species,sml_species):
    ...
    assert np.allclose(sim_molecule.positions, [[ 0.      ,  0.      ,  0.116489],
                                                [ 0.      ,  0.939731, -0.271808],
    ...
    assert np.allclose(file_molecule.positions,[[ 0.      ,  0.      ,  0.116489],
                                                [ 0.      ,  0.939731,  0.408   ],

...
from HTMACat.model.Ads import Species,Adsorption,Coadsorption
...
@pytest.fixture
def species():
    species1 = Species(form='N',sml=True)
    species2 = Species(form='[O]',sml=True)
...
def test_construct_coadsorption_11(coads11):
    ...
    assert len(slab_ad_final) == 22
    assert np.allclose(slab_ad_final[0].numbers, [78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78,
